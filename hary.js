/*
 - Create By HARY-IT
 - Contact Me on https://wa.me/+6282273128721
 - Base Dika 
...
console.log('\x1b[1;34m~\x1b[1;37m>', '[\x1b[1;33mCMD\x1b[1;37m]', time, color(`${prefix + command} [${args.length}]`, 'cyan'), 'from', color(m.pushName), 'in', color(groupName, 'orange'))
        ...
        // Leveling Punya Chika 🗿🗿 Di Copas Oleh HARY-IT
...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./media/image/logo.png'), 2022, "HARY-IT", "6282273128721@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
let butRun = [
        	...
        	mans.sendMessage(m.chat, { caption: listmn, document: { url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx' }, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: '© HARY-IT By HARY-IT Dev', templateButtons: butRun, footer: `🌏 Dont Spam & Telpon Bot`, mentionedJid: [m.sender] })
        	break
...
case 'me': case 'inventori': case 'profile':{
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     let butRun = [
        	{ urlButton: { displayText: `📝 From Group WhatsApp`, url : `https://chat.whatsapp.com/JDm1hDOfH7q3zp2mC8xaZh` } },
        	{ urlButton: { displayText: `🎯 Rest Api`, url : `https://haryonokudadiri.cloud` } },
            { urlButton: { displayText: `☎️Contact Me`, url: `+62 822-7312-8721` } },
            { quickReplyButton: { displayText: `🏧 leaderboard`, id: 'leaderboard'} }
        	]
        	mans.sendMessage(m.chat, { caption: teksehmazeh, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: '© HARY-IT Store', templateButtons: butRun, footer: `ingin Berpetualang Lagi`, mentions: [m.sender] })
        	}
        	break
...
hydratedFooterText: "© HARY-IT - X - HARY-IT",
hydratedButtons: [{
urlButton: {
displayText: 'Group Whatsapp',
url: 'https://chat.whatsapp.com/JDm1hDOfH7q3zp2mC8xaZh'
}
}, {
urlButton: {
...
*GRUP 1*
https://chat.whatsapp.com/JDm1hDOfH7q3zp2mC8xaZh
...
case 'coffe': case 'kopi': {
            let buttons = [
                ...
                let buttonMessage = {
                    ...
                    footer: `Created By © HARY-IT Store`,
                    buttons: buttons,
                    headerType: 4
                }
                mans.sendMessage(m.chat, buttonMessage, { quoted: m })
...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./media/image/mans.jpg'), 2022, "HARY-IT", "6283155687629@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 50) {
await mans.groupAcceptInvite(vcc).then(async(res) => m.reply(jsonformat(res))).catch(_ => _)
m.reply("Succes")
} else {
...
case 'nulis': {
if (isBan) return m.reply(mess.ban)
if (args.length < 1) return m.reply(`Example :\n${prefix}nulis HARY-IT|91|#ff020a|Manusia terganteng adalah salman alfarizi`)
const nls = args.join(" ")
...
mans.setStatus(`Mode : Public Created By HARY-IT Store`)
}
break
case 'setstatut':
case 'setbio':
...
mans.setStatus(`Mode : Self Created By HARY-IT Store`)
}
break
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"HARY-IT - Twitter Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"HARY-IT - Facebook Downloader",
...
case 'iqra': {
		...
		mans.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf By HARY-IT Store`}, {quoted:m}).catch ((err) => m.reply(oh))
		}
		break
		case 'juzamma': {
		if (args[0] === 'pdf') {
...
mans.sendMessage(from, {video:{url:buffer}, mimetype:"video/mp4", caption:"By HARY-IT Store"}, {quoted:m})
break
case 'asupan-santuy':
case 'asupansantuy':
 fakey(mess.wait)
...
let buttons = [
                ...
                let buttonMessage = {
                    image: { url: 'https://haryit.github.io/logo.png' },
                    caption: `${tes.result}`,
...
.then((a) => {
      ...
      mans.sendMessage(from, { video: { url: dl_link }, caption: "By HARY-IT Store" }, { quoted: m })
      })
...
// Anti Tag ( HARY-IT )
const listTag = ["6282273128721@s.whatsapp.net"]
const partiNum = (m.mtype === 'extendedTextMessage') ? m.message.extendedTextMessage.contextInfo.participant : ''
// Antitag Via Reply ( HARY-IT )
...
// Antitag Via Tag ( HARY-IT )
if (budy.includes("@6282273128721")) {
if (antitags === false) return
if (!m.isGroup) return
if (m.key.fromMe) return
mans.sendReadReceipt(m.chat, m.sender, [m.key.id])
...
mans.sendMessage("6282273128721@s.whatsapp.net", util.format(err), {quoted:m})
console.log(err)
}
}
